#define MICROPY_HW_BOARD_NAME       "Smart Antenna"
#define MICROPY_HW_MCU_NAME         "STM32F745"
#define MICROPY_HW_FLASH_FS_LABEL   "SMARTANTENNA"
...
#define MICROPY_PY_HASHLIB          (MICROPY_PY_SSL && MICROPY_SSL_AXTLS)
...
// UART config
#define MICROPY_HW_UART1_TX         (pin_B6) // F9H1_TXD GPS2
#define MICROPY_HW_UART1_RX         (pin_B7) // F9H1_RXD GPS2
// #define MICROPY_HW_UART2_TX         (pin_D5) // F9H2_TXD GPS3
// #define MICROPY_HW_UART2_RX         (pin_D6) // F9H2_RXD GPS3
...
#define MICROPY_HW_UART7_TX         (pin_E8)// XBEE_A_TXD
#define MICROPY_HW_UART7_RX         (pin_E7)// XBEE_A_RXD
...
#define MICROPY_HW_I2C2_SCL         (pin_B10)	// IBUS_I2C_SCL
#define MICROPY_HW_I2C2_SDA         (pin_B11)	// IBUS_I2C_SDA
...
// LEDs
#define MICROPY_HW_LED1             (pin_A0)    // LED1
#define MICROPY_HW_LED2             (pin_A1)    // LED2
#define MICROPY_HW_LED3             (pin_A2)    // LED3
#define MICROPY_HW_LED4             (pin_A3)    // LED4
#define MICROPY_HW_LED5             (pin_A6)    // LED5
#define MICROPY_HW_LED6             (pin_A7)    // LED6
#define MICROPY_HW_LED_ON(pin)      (mp_hal_pin_high(pin))
#define MICROPY_HW_LED_OFF(pin)     (mp_hal_pin_low(pin))

// USB config (CN13 - USB OTG FS)
#define MICROPY_HW_USB_FS              (1)
#define MICROPY_HW_USB_OTG_ID_PIN      (pin_C2)
