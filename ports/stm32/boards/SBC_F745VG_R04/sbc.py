"""Single Board Computer (SBC) module R04"""
...
from sdk.modules.bno08x import BNO08x, Axes
...
XBEE_A = XBeeSocket(4, baudrate=115200, power=DigitalIO(pin="PWR_XBA"))
XBEE_B = XBeeSocket(6, baudrate=115200, power=DigitalIO(pin="PWR_XBB"))
...
IMU = BNO08x(i2c=i2c, mount=Axes(x='N', y='W', z='U'))
