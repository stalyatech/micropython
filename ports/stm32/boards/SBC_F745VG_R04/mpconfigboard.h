#define MICROPY_HW_BOARD_NAME       "simpleRTK2B-SBC-R04"
...
// LEDs
#define MICROPY_HW_LED1             (pin_B1)    // LED1
#define MICROPY_HW_LED2             (pin_B2)    // LED2
#define MICROPY_HW_LED3             (pin_E7)    // LED3
